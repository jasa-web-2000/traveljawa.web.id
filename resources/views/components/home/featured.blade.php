@php
    $featured = [
        [
            ...
            'description' =>
                'Temukan layanan travel terpercaya dengan harga ramah di kantong. Nikmati perjalanan yang aman, nyaman, dan selalu tepat waktu ke berbagai destinasi favorit Anda!.',
        ],
        [
            'icon' =>
            ...
            'description' =>
                'Nikmati layanan antar jemput door to door langsung dari rumah ke tujuan Anda. Solusi praktis, nyaman, dan selalu tepat waktu setiap hari tanpa ribet!',
        ],
        [
            'icon' => 'M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
            'subSubTitle' => 'Jadwal 24 Jam',
            'description' =>
                'Travel 24 jam siap antar kapan pun Anda butuh, layanan fleksibel, cepat, dan selalu tersedia tanpa batas waktu. Solusi perjalanan tanpa khawatir waktu!',
        ],
        [
            'icon' =>
            ...
            'description' =>
                'Setiap armada kami dilengkapi AC dingin untuk menjamin kenyamanan maksimal sepanjang perjalanan. Tetap segar, nyaman, dan bebas gerah dari awal hingga sampai tujuan.',
        ],
        [
            'icon' => 'm21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9',
            'subSubTitle' => 'Free Bagasi 15kg',
            'description' =>
                'Dapatkan fasilitas bagasi gratis hingga 15kg tanpa biaya tambahan! Bawa barang bawaan lebih banyak dengan leluasa, tanpa khawatir biaya ekstra.',
        ],
        [
            'icon' =>
            ...
            'description' =>
                'Booking travel kini super mudah! Cukup hubungi kami via WhatsApp untuk pemesanan cepat, tanpa ribet. Layanan responsif dan aman tersedia setiap hari.',
        ],
    ];
...
<div class="relative">
    ...
    <div class="relative my-container text-center py-20">
        <x-sub-heading type="light" subTitle='Keuntungan Travel Bersama Kami'
            description='Travel bersama kami dan dapatkan berbagai keuntungan menarik.' />
